<?php
require_once("../../../classes/WSBilling.php");
...
$WSBilling->add_attributes($xmlObj, array("conta" => "9023010379530170","senha" => "142536"));
$WSBilling->add_content($xmlObj,"André Martins Brandao");//$linha_dados->cedente_gatewaypgfc

// Cria o elemento cobranca
$xmlObjCobranca = $WSBilling->add_node($xmlObjF2bCobranca,"cobranca");
$WSBilling->add_attributes($xmlObjCobranca, array("valor" => "10.00","tipo_cobranca" => "","num_document" => "","cod_banco" => ""));
...
$WSBilling->add_attributes($xmlObj, array("valor" => "1.0",  "tipo_multa" => "0","valor_dia" => "0.10", "tipo_multa_dia" => "0","atraso" => "20"));
...
$WSBilling->add_attributes($xmlObj, array("logradouro" => "Rua das Pedras","numero" => "455","complemento" => "sala 23","bairro" => "Itaim Bibi","cidade" => "São Paulo","estado" => "SP","cep" => "04536000"));
// Cria o elemento telefone
$xmlObj = $WSBilling->add_node($xmlObjSacado,"telefone");
$WSBilling->add_attributes($xmlObj, array("ddd" => "11","numero" => "35551234"));

// Cria o elemento telefone comercial
$xmlObj = $WSBilling->add_node($xmlObjSacado,"telefone_com");
$WSBilling->add_attributes($xmlObj, array("ddd_com" => "22","numero_com" => "22222222"));

// Cria o elemento telefone celular
$xmlObj = $WSBilling->add_node($xmlObjSacado,"telefone_cel");
$WSBilling->add_attributes($xmlObj, array("ddd_cel" => "33","numero_cel" => "33333333"));
